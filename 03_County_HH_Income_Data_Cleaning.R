...
#County level HH income data 2007-11
county_07_11 <- read_csv(here(
  "data",
  "raw",
  "nhgis0047_csv",
  "nhgis0047_ds184_20115_county.csv"
))
...
save(county_07_11, file = "data/processed/county_hh_income_07_11.rdata")
