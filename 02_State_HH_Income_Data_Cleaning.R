...
#
# State Level Household Income in Past 12 Months Data Cleaning
...
#State level HH income data 2007-11
state_07_11 <- read_csv(here(
  "data",
  "raw",
  "nhgis0045_csv",
  "nhgis0045_ds184_20115_state.csv"
))
...
save(state_07_11, file = "data/processed/state_hh_income_07_11.rdata")
